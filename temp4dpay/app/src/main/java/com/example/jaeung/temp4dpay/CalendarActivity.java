...
public class CalendarActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //버튼 등록 및 리스너 등록
        Button leftMonthButton = (Button) findViewById(R.id.leftButton);
        leftMonthButton.setOnClickListener(this);
        Button rightMonthButton = (Button) findViewById(R.id.rightButton);
       ...
       //         setDay = dayOfMonth;
        ...
        //리스트뷰 연결
        calendarListView = (ListView) findViewById(R.id.dayHouseHold);
        //어댑터 연결
